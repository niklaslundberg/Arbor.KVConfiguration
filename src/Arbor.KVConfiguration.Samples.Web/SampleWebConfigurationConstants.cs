...
namespace Arbor.KVConfiguration.Samples.Web
{
    ...
    public static class SampleWebConfigurationConstants
    {
        ...
        [Metadata("urn", defaultValue: "ThisIsAnotherDefaultSourceValue")] public const string
            ATestKey = "urn:test:key:with:another:default:value";

        [Metadata("urn", defaultValue:"ThisIsTheDefaultSourceValue")] public const string
