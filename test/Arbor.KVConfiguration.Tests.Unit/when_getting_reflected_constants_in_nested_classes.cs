...
namespace Arbor.KVConfiguration.Tests.Unit
{
    ...
    public class when_getting_reflected_constants_in_nested_classes
    {
        ...
        {
            configuration_items.FirstOrDefault(x => x.Key == ClassWithNestedClasses.NestedA.NestedKeyA).Value
                .ShouldNotBeNull();
        };
        ...
        {
            configuration_items.FirstOrDefault(x => x.Key == ClassWithNestedClasses.NestedB.NestedKeyB).Value
                .ShouldNotBeNull();
        };
    }
}